        ...
        switch (get_highest_layer(layer_state | default_layer_state)) {
            ...
            case 0:
                if (keymap_config.swap_lctl_lgui) {
                  ...
                  lv_img_set_src(ui_Layer_Indicator, &fedora);
                }
                break;
                */
            case HDN:
            case CMK:
                if (detected_host_os()==OS_LINUX) {
                  lv_img_set_src(ui_Layer_Indicator, &fedora);
                } else if (detected_host_os()==OS_MACOS || detected_host_os()==OS_IOS) {
                  lv_img_set_src(ui_Layer_Indicator, &apple);
                } else if (detected_host_os()==OS_WINDOWS){
                  lv_img_set_src(ui_Layer_Indicator, &window);
                } else {
                  lv_img_set_src(ui_Layer_Indicator, &thonk);
                }
                break;
            case NAV:
            ...
            case SYM:
                ...
                break;
            case ADJ:
                lv_img_set_src(ui_Layer_Indicator, &gear);
                break;
        }
  }
}
...
void display_init(void) {
    ...
    lv_obj_set_y(ui_Screen1_Label_ALTMOD, -23);
    ...
    lv_obj_set_y(ui_Screen1_Label_CMDMOD, -50);
    ...
    // Writes "CMK" if colemak layer enabled
    /*
    ui_Screen1_Label_CMK = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_Screen1_Label_CMK, 150);
    lv_obj_set_style_text_font(ui_Screen1_Label_CMK, &rb_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_x(ui_Screen1_Label_CMK, 25);
    lv_obj_set_y(ui_Screen1_Label_CMK, 120);
    lv_label_set_text(ui_Screen1_Label_CMK, "CMK");
    */
